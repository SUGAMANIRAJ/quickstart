...
# Load models once
vgg_model = load_model("/mnt/c/Users/mythi/quickstart/nada_quickstart_programs/resrc/vgg_model.h5")
vgg_model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'])

resnet_model = load_model("/mnt/c/Users/mythi/quickstart/nada_quickstart_programs/resrc/resnet_model.h5")
